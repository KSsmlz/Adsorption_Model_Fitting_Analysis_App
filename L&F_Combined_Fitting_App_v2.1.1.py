        ...
        if model_type == "Langmuir":
            ...
            def toggle_coords1():
                ...
                if show_coords1:
                    annotations1 = []
                    for c, s in zip(C_values, S_values):
                        annotation = ax1.annotate(f'({c:.2f}, {s:.2f})', xy=(c, s), xytext=(3, 3),
            ...
            coords_button1 = ttk.Button(frame1, text="Show Coordinates", command=toggle_coords1, style='TButton',
                                        width=15)
            coords_button1.pack(side=tk.BOTTOM, pady=5)
            ...
            def toggle_coords2():
                ...
                if show_coords2:
                    ...
                    for c, cs in zip(C_values, np.array(C_values) / np.array(S_values)):
                        annotation = ax2.annotate(f'({c:.2f}, {cs:.2f})', xy=(c, cs), xytext=(3, 3),
                                                  textcoords='offset points', fontsize=8)
            ...
            coords_button2 = ttk.Button(frame2, text="Show Coordinates", command=toggle_coords2, style='TButton',
                                        width=15)
            coords_button2.pack(side=tk.BOTTOM, pady=5)
            ...
            def toggle_coords3():
                ...
                if show_coords3:
                    annotations3 = []
                    for c, s in zip(C_values, S_values):
                        annotation = ax3.annotate(f'({c:.2f}, {s:.2f})', xy=(c, s), xytext=(3, 3),
                                                  textcoords='offset points', fontsize=8)
            ...
            coords_button3 = ttk.Button(frame3, text="Show Coordinates", command=toggle_coords3, style='TButton',
                                        width=15)
            coords_button3.pack(side=tk.BOTTOM, pady=5)
            ...
            def toggle_coords4():
                ...
                if show_coords4:
                    ...
                    for c, s in zip(C_log_values_selected, S_log_values_selected):
                        annotation = ax4.annotate(f'({c:.2f}, {s:.2f})', xy=(np.log10(c), np.log10(s)), xytext=(3, 3),
                                                  textcoords='offset points', fontsize=8)
            ...
            coords_button4 = ttk.Button(frame4, text="Show Coordinates", command=toggle_coords4, style='TButton',
                                        width=15)
            coords_button4.pack(side=tk.BOTTOM, pady=5)
