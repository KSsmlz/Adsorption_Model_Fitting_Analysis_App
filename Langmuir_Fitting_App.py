...
c_entry.grid(row=0, column=1, padx=5, pady=5)
...
data_tree.grid(row=2, column=0, columnspan=3, padx=10, pady=10)

# Analysis button
analyze_button = tk.Button(window, text="Analyze Data", command=analyze_data)
analyze_button.grid(row=3, column=0, columnspan=3, padx=10, pady=10)
