...
def refresh_data_frame():
    ...
    tk.Label(data_scrollable_frame, text="C", font=('Arial', 14, 'bold'), bg='#f0f0f0').grid(row=0, column=0, padx=30,
                                                                                             pady=2, sticky='e')
    tk.Label(data_scrollable_frame, text="S", font=('Arial', 14, 'bold'), bg='#f0f0f0').grid(row=0, column=1, padx=30,
                                                                                             pady=2, sticky='e')

    for i, (c, s) in enumerate(data_list):
        c_str = f"{c:.6f}"  # Format C to 6 decimal places
        s_str = f"{s:.6f}"  # Format S to 6 decimal places
        ...
        c_label.grid(row=i + 1, column=0, padx=(30, 5), pady=2, sticky='e')  # Adjust padx for alignment
        s_label.grid(row=i + 1, column=1, padx=(5, 30), pady=2, sticky='e')  # Adjust padx for alignment
