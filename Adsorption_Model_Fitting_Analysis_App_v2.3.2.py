...
def analyze_data():
    ...
    try:
        if model_type == "Linear":
            ...
            ax1.plot(C_smooth, S_fit, 'r-', label='Linear Fit', linewidth=1.5)
            ...
            ax1.set_title('Linear Adsorption Isotherm', fontsize=12, fontweight='bold')
            ...
            ax1.set_xlim(0, max_C_l * 1.1)
            ax1.set_ylim(0, max_S_l * 1.1)
            ...
            notebook.add(frame1, text='Linear Isotherm')
            ...
            ax2.scatter(all_C_values, all_S_values, label='All Dfata Points', color='#66b3ff', alpha=0.5, s=15)
            ax2.scatter(C_values, S_values, label='Selected Data Points', color='#008000', s=20)


            ax2.plot(C_smooth, S_fit, 'r-', label='Langmuir Fit', linewidth=1.5)
            ax2.set_xlabel('Concentration (C) [unit]', fontsize=10, fontweight='bold')
            ax2.set_ylabel('Adsorption Amount (S) [unit]', fontsize=10, fontweight='bold')
            ax2.set_title('Langmuir Adsorption Isotherm', fontsize=12, fontweight='bold')
            ...
            ax3.scatter(all_C_values, np.array(all_C_values) / np.array(all_S_values), label='All Data Points',
                        color='#66b3ff', alpha=0.5, s=15)
            ax3.scatter(C_values, np.array(C_values) / np.array(S_values), label='Selected Data Points',
                        color='#ffa500', s=20)
            ...
            ax3.plot(C_fit_smooth, CS_fit_smooth, 'r--', label='Fit', linewidth=1.5)

            ax3.set_xlabel('Concentration (C) [unit]', fontsize=10, fontweight='bold')
            ax3.set_ylabel('C/S [unit]', fontsize=10, fontweight='bold')
            ax3.set_title('Langmuir C/S vs. C Plot', fontsize=12, fontweight='bold')
            ax3.legend(fontsize=8, frameon=True, facecolor='white', edgecolor='grey', framealpha=0.8)
            ax3.grid(True, linestyle='--', alpha=0.6)
            fig3.patch.set_facecolor('white')  # Setting background color for the figure
            ...
            # 設定 X 和 Y 軸的邊界，並留一些空間
            ax3.set_xlim(0, max_C_cs * 1.1)
            ax3.set_ylim(0, max_CS * 1.1)
            ...
            notebook.add(frame2, text='Langmuir Isotherm')
            notebook.add(frame3, text='Langmuir C/S vs. C')
            ...
            def toggle_coords2():
                ...
                if show_coords2:
                    ...
                    for c, s in zip(C_values, S_values):
                        c_str = f"{c:.4f}" if c < 10 else f"{c:.1f}"
                        s_str = f"{s:.4f}" if s < 10 else f"{s:.1f}"
                        annotation = ax2.annotate(f'({c_str}, {s_str})', xy=(c, s), xytext=(3, 3),
                                                  textcoords='offset points', fontsize=8)
            ...
            view_selected_button2 = ttk.Button(frame2, text="View Selected", command=view_selected_data2,
                                               style='TButton', width=12)
            ...
            def toggle_coords3():
                ...
                if show_coords3:
                    ...
                    for c, cs in zip(C_values, np.array(C_values) / np.array(S_values)):
                        ...
                        annotation = ax3.annotate(f'({c_str}, {cs_str})', xy=(c, cs), xytext=(3, 3),
                                                  textcoords='offset points', fontsize=8)
            ...
            view_selected_button3 = ttk.Button(frame3, text="View Selected", command=view_selected_data3, style='TButton', width=12)
            ...
            ax4.scatter(all_C_values, all_S_values, label='All Data Points', color='#66b3ff', alpha=0.5, s=15)
            ax4.scatter(C_values, S_values, label='Selected Data Points', color='#008000', s=20)

            ax4.plot(C_smooth, S_fit, 'r-', label='Freundlich Fit', linewidth=1.5)
            ax4.set_xlabel('Concentration (C) [unit]', fontsize=10, fontweight='bold')
            ax4.set_ylabel('Adsorption Amount (S) [unit]', fontsize=10, fontweight='bold')
            ax4.set_title('Freundlich Adsorption Isotherm', fontsize=12, fontweight='bold')
            ...
            # 設定 X 和 Y 軸的邊界，並留一些空間
            ax4.set_xlim(0, max_C_f * 1.1)
            ax4.set_ylim(0, max_S_f * 1.1)
            ...
            if len(C_log_values) > 0 and len(S_log_values) > 0:
                ax5.scatter(np.log10(C_log_values), np.log10(S_log_values), label='All Data Points', color='#66b3ff',
                            alpha=0.5, s=15)
            ...
            if len(C_log_values_selected) > 0 and len(S_log_values_selected) > 0:
                ax5.scatter(np.log10(C_log_values_selected), np.log10(S_log_values_selected),
            ...
            if len(C_smooth_log) > 0 and len(S_fit_log) > 0:
                ax5.plot(np.log10(C_smooth_log), np.log10(S_fit_log), 'r--', label='Log Scale Fit', linewidth=1.5)

            ax5.set_xlabel('log(Concentration (C)) [unit]', fontsize=10, fontweight='bold')
            ax5.set_ylabel('log(Adsorption Amount (S)) [unit]', fontsize=10, fontweight='bold')
            ax5.set_title('Log Scale Freundlich Adsorption Isotherm', fontsize=12, fontweight='bold')
            ...
            notebook.add(frame4, text='Freundlich Isotherm')
            notebook.add(frame5, text='Freundlich Log Scale')
            ...
            def toggle_coords4():
                ...
                if show_coords4:
                    ...
                    for c, s in zip(C_values, S_values):
                        c_str = f"{c:.4f}" if c < 10 else f"{c:.1f}"
                        s_str = f"{s:.4f}" if s < 10 else f"{s:.1f}"
                        annotation = ax4.annotate(f'({c_str}, {s_str})', xy=(c, s), xytext=(3, 3),
                                                  textcoords='offset points', fontsize=8)
            ...
            def toggle_coords5():
                ...
                if show_coords5:
                    ...
                    for c, s in zip(C_log_values_selected, S_log_values_selected):
                        c_str = f"{c:.4f}" if c < 10 else f"{c:.1f}"
                        s_str = f"{s:.4f}" if s < 10 else f"{s:.1f}"
                        annotation = ax5.annotate(f'({c_str}, {s_str})', xy=(np.log10(c), np.log10(s)), xytext=(3, 3),
                                                  textcoords='offset points', fontsize=8)
...
data_scrollable_frame = tk.Frame(data_frame_canvas, bg='#f0f0f0')
