...
def refresh_data_frame():
    ...
    tk.Label(data_scrollable_frame, text="C", font=('Arial', 14, 'bold'), bg='#f0f0f0').grid(row=0, column=1,
                                                                                             padx=(50, 5), pady=2,
                                                                                             sticky='e')
    tk.Label(data_scrollable_frame, text="S", font=('Arial', 14, 'bold'), bg='#f0f0f0').grid(row=0, column=2,
                                                                                             padx=(5, 50), pady=2,
                                                                                             sticky='e')
    ...
    for i, (c, s) in enumerate(data_list):
        ...
        c_label.grid(row=i + 1, column=1, padx=(50, 5), pady=2, sticky='e')  # Adjust padx for alignment
        s_label.grid(row=i + 1, column=2, padx=(5, 50), pady=2, sticky='e')  # Adjust padx for alignment

        tk.Checkbutton(data_scrollable_frame, variable=check_vars[i], bg='#f0f0f0').grid(row=i + 1, column=0, padx=5,
                                                                                         pady=2, sticky='w')
...
add_button.grid(row=3, column=0, padx=(2, 2), pady=2, sticky='e')

delete_button = ttk.Button(input_frame, text="Delete", command=delete_data, style='TButton', width=7)
delete_button.grid(row=3, column=1, padx=(5, 2), pady=2, sticky='e')
