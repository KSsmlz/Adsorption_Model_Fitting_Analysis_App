...
def refresh_data_frame():
    ...
    tk.Label(data_scrollable_frame, text="No.", font=('Arial', 14, 'bold'), bg='#f0f0f0').grid(row=0, column=1,
                                                                                               padx=(10, 10), pady=2,
                                                                                               sticky='nsew')  # Change "Group" to "No."
    ...
    for i, (c, s, group_id) in enumerate(data_list):
        ...
        c_label.grid(row=i + 1, column=2, padx=(20, 20), pady=2, sticky='e')  # Adjust padx for alignment
        s_label.grid(row=i + 1, column=3, padx=(20, 50), pady=2, sticky='e')  # Adjust padx for alignment
