...
def refresh_data_frame():
    ...
    for i, (c, s) in enumerate(data_list):
        ...
        c_label.grid(row=i + 1, column=1, padx=(20, 20), pady=2, sticky='e')  # Adjust padx for alignment
        s_label.grid(row=i + 1, column=2, padx=(20, 50), pady=2, sticky='e')  # Adjust padx for alignment
