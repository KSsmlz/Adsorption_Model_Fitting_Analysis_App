...
style.configure('TButton', font = ('Arial', 12), borderwidth = 0, relief = 'flat', background = '#4CAF50', foreground = '#000000', padding = 8)
# Style for buttons
button_style = {
    'font': ('Arial', 12),
    'borderwidth': 0,
...
bulk_c_button = ttk.Button(window, text="Bulk C Input", command=bulk_c_input, style = 'TButton')
bulk_c_button.grid(row=1, column=2, padx=5, pady = 5, sticky = 'w')
...
bulk_s_button = ttk.Button(window, text="Bulk S Input", command=bulk_s_input, style = 'TButton')
bulk_s_button.grid(row=2, column=2, padx=5, pady = 5, sticky = 'w')
...
delete_button.grid(row=4, column=2, padx=5, pady=5, sticky='w')


data_frame = tk.Frame(window, bg = '#f0f0f0')
data_frame.grid(row=5, column=0, columnspan=3, padx=10, pady=10, sticky='nsew')
data_list = []
check_vars = {}

select_all_button = ttk.Button(window, text="Select/Deselect All", command=toggle_all, style = 'TButton')
select_all_button.grid(row=6, column = 2, padx = 5, pady = 5, sticky = 'w')


analyze_button = ttk.Button(window, text="Analyze Data", command=analyze_data, style = 'TButton')
analyze_button.grid(row=7, column=0, columnspan=3, padx=10, pady=10, sticky='ew')

result_text = tk.Text(window, height=4, width=60, state=tk.DISABLED, font = ('Arial', 12), bg = '#f0f0f0')
result_text.grid(row=8, column=0, columnspan=3, padx=10, pady=10, sticky='ew')
